...
## Academic legal analysis (introduction)
...
**Incident and record foundation.** On **February 4, 2021**, a pedestrian-vehicle encounter at **Tehama Street and Fifth Street** in San Francisco anchors the later civil dockets. For **911 audio**, **CAD**, and **body-worn camera** mirrors, start at [evidence.md](evidence.md). For the driver’s **trial-day authentication** of a recording excerpt, compare the same evidence page with the **Day 8** reporter volume for **April 17, 2025** ([Trial-Day-08-April-17-2025.pdf](05-TRANSCRIPTS/REPORTER-TRANSCRIPTS/Trial-Day-08-April-17-2025.pdf)). Read together, those sources support a disciplined question: what did emergency and field channels capture near the time of impact, and how did trial testimony treat those items. The evidence page also collects images and short text excerpts so a reader can move from **narrative** back to **machine-readable** PDFs without treating any single pull-quote as a substitute for the full reporter day.

**Underlying trial (CGC-21-594102).** The superior-court file presents **negligence**, **liability**, and **damages** themes as conventional personal-injury issues. The **clerk’s transcript** compiles orders, motion rulings, and instruction-related materials that later briefs cite as **procedural history** ([CGC-21-594102-A173827-Clerks-Transcript-Full.pdf](05-TRANSCRIPTS/CLERKS-TRANSCRIPT/CGC-21-594102-A173827-Clerks-Transcript-Full.pdf)). **Reporter** volumes for mid-trial days include **April 16, 2025** ([Day 7 PDF](05-TRANSCRIPTS/REPORTER-TRANSCRIPTS/Trial-Day-07-April-16-2025.pdf)), **April 17, 2025** ([Day 8 PDF](05-TRANSCRIPTS/REPORTER-TRANSCRIPTS/Trial-Day-08-April-17-2025.pdf)), and **April 23, 2025** ([Day 11 PDF](05-TRANSCRIPTS/REPORTER-TRANSCRIPTS/Trial-Day-11-April-23-2025.pdf)). Deposition PDFs and indices are listed at [05-TRANSCRIPTS/INDEX.md](05-TRANSCRIPTS/INDEX.md). The appeal later reframes portions of this same paper record; the trial layer therefore remains the factual substrate for both **direct review** and **collateral** papers filed after judgment. When a post-trial pleading quotes trial speech, the correct academic habit is to **open the reporter PDF** and confirm speaker, day, and line references rather than relying on secondary characterizations.

**Appeal (A173827).** The **appellant’s opening brief** catalogs issues that fall into familiar California buckets: **instructional** questions (often reviewed **de novo** on a pure question of law), **evidentiary** rulings (typically reviewed for **abuse of discretion** with prejudice filters), **juror misconduct** and **Evidence Code section 1150** process, and **structural** or **cumulative** error arguments that depend on interlocking rulings ([01-Appellants-Opening-Brief.pdf](01-APPEAL/01-Appellants-Opening-Brief.pdf)). The appeal index groups briefs and exhibits ([01-APPEAL/INDEX.md](01-APPEAL/INDEX.md)). Treat each heading in the brief as a **hypothesis about reversible error**, then walk the cited pages in the reporter PDFs and clerk’s transcript rather than inferring facts from this homepage alone. Exhibits bound with appellate briefing (for example **exhibit PDFs** listed in the same index) often carry **authentication** and **chain-of-custody** arguments that tie back to the trial-day PDFs above.

**Equity and extrinsic fraud (CGC-25-631801).** Plaintiff’s **second amended complaint** and related memoranda articulate **fraud on the court**, **extrinsic fraud**, **civil conspiracy**, **aiding and abetting**, and **professional-conduct** strands tied to California’s **Rules of Professional Conduct** and **Business and Professions Code** frameworks, always as **claims in a pleading** rather than as adjudicated facts ([01-Second-Amended-Complaint.pdf](02-CASE-CGC-25-631801/01-Second-Amended-Complaint.pdf); [03-Memorandum-Fraud-on-Court.pdf](02-CASE-CGC-25-631801/03-Memorandum-Fraud-on-Court.pdf)). A focused motion PDF isolates a **Navaratnasingham** admission line discussed in equity briefing ([11-Motion-Extrinsic-Fraud-Navaratnasingham-Admission.pdf](02-CASE-CGC-25-631801/11-Motion-Extrinsic-Fraud-Navaratnasingham-Admission.pdf)). For a plaintiff-authored analytical annex that strings citations across transcripts and pleadings, see [FATAL-PROOF-NAVARATNASINGHAM-DOLAN-ADMISSION-EXTRINSIC-FRAUD.md](08-LEGAL-ANALYSIS/FATAL-PROOF-NAVARATNASINGHAM-DOLAN-ADMISSION-EXTRINSIC-FRAUD.md), labeled elsewhere in this site as **non-filing** commentary. Defendant-facing pages that map individuals and entities to primary PDFs begin at [defendants/INDEX.md](defendants/INDEX.md); use them when you need a **caption check** against the SAC’s party list.

**UCL and denial-letter work (CGC-25-631802).** The **Unfair Competition Law**, **Business and Professions Code section 17200**, appears in the FAC and supporting memoranda through **unfair**, **unlawful**, and **fraudulent** prongs, including theories about **fraudulent omission** tied to insurer communications. The **CSAA investigation** exhibit is a fixed anchor for what the file claims about file completeness ([EXHIBIT-001-CSAA-Investigation-Report.pdf](04-EXHIBITS/EXHIBIT-001-CSAA-Investigation-Report.pdf)), while the **denial-letter memorandum** states plaintiff’s document-based theory ([03-Memorandum-Denial-Letter-Fraud.pdf](03-CASE-CGC-25-631802/03-Memorandum-Denial-Letter-Fraud.pdf)). **April 2026** motion practice for demurrer and Anti-SLAPP is organized in hubs for the **demurrer volley** ([demurrer-volley-apr2026/README.md](03-CASE-CGC-25-631802/demurrer-volley-apr2026/README.md)), **defense Anti-SLAPP** ([defense-anti-slapp-clerk/README.md](03-CASE-CGC-25-631802/defense-anti-slapp-clerk/README.md)), **plaintiff opposition** ([plaintiff-opposition-consolidated-apr2026/README.md](03-CASE-CGC-25-631802/plaintiff-opposition-consolidated-apr2026/README.md)), and **FINAL-COURT** exhibit-integrated bundles ([final-court-apr2026/README.md](03-CASE-CGC-25-631802/final-court-apr2026/README.md)). For a declaration-level rebuttal track on **Tyler J. O'Connell**, see [tyler-oconnell-declaration-rebuttal.md](08-LEGAL-ANALYSIS/anti-slapp-rebuttal/tyler-oconnell-declaration-rebuttal.md). The **FIRST** pleading PDF for this branch is the operative complaint family in the case index ([03-CASE-CGC-25-631802/INDEX.md](03-CASE-CGC-25-631802/INDEX.md)), which links the FAC and motion responses without merging them into a single narrative.

**Causes of action, consolidated list.** Read **negligence and damages** in the trial forum through the transcript tree above. Read **appellate error** categories through the opening brief PDF. Read **631801** claims through the SAC and fraud memoranda, with defendants cross-linked at [defendants/INDEX.md](defendants/INDEX.md). Read **631802** UCL and related theories through the FAC ([01-First-Amended-Complaint.pdf](03-CASE-CGC-25-631802/01-First-Amended-Complaint.pdf)) and denial-letter memorandum, then follow the **element-to-source** table at [evidence-tree/INDEX.md](evidence-tree/INDEX.md). **631801** fraud-on-the-court and extrinsic-fraud counts appear in the SAC counts and fraud memorandum; **conspiracy** and **aiding-and-abetting** counts likewise appear as **pled labels** whose elements must be traced inside the same PDFs rather than on this page. **631802** adds consumer-style theories (for example **unlawful** business acts and **fraudulent** practices) that the FAC organizes with separate **DEMAND FOR JURY TRIAL** and **prayer** sections the reader should verify in the PDF. Each path above ends in a **named PDF** so the reader can verify captions, dates, and party labels the same way a law clerk would.

**Cross-forum reading method.** The same names recur across forums (driver, insurer, trial and successor counsel). The academically sound move is to **keep the forums separate**: use **631802** PDFs for insurer-facing theories, **631801** PDFs for equity and fraud-on-the-court theories, **A173827** PDFs for instructional and evidentiary error catalogues, and **594102** reporters for sworn speech and clerk’s orders. When **April 2026** consolidated opposition PDFs cite trial pages, treat the **reporter PDF** as the authority for quoted lines; when those PDFs cite insurer letters, treat the **exhibit PDFs** in the opposition appendices or the **631802** register as the authority. The **FINAL-COURT** folder adds a **source-pdfs** index ([final-court-apr2026/source-pdfs/README.md](03-CASE-CGC-25-631802/final-court-apr2026/source-pdfs/README.md)) that maps each pre-merge instrument to the exhibit-integrated bundles so a reader can zoom from **macro packet** to **single filing**.

---

## One-page chronology (links are the footnotes)

On **February 4, 2021**, a pedestrian–vehicle incident occurred at **Tehama and 5th Street**, San Francisco. Audio and transcript excerpts are on [evidence.md](evidence.md). Depositions followed through **2024** ([deposition PDFs — transcripts index](05-TRANSCRIPTS/INDEX.md#depositions)). A **February 18, 2025** hearing register is in [All-Hearing-Transcripts-Rosario-AAA.pdf](05-TRANSCRIPTS/HEARINGS/All-Hearing-Transcripts-Rosario-AAA.pdf).
...
<a id="appendix-legacy-full-record"></a>

## Appendix — Original full case record (README.LEGACY)

The section below matches [README.LEGACY.md](README.LEGACY.md) (same links and tables). Only change: the former top-level `#` title is demoted to **`##`** so this page keeps a single primary `H1`.
...
**Last updated (public PDF sync):** April 18, 2026. **CGC-25-631802:** CSAA Anti-SLAPP clerk PDFs; Plaintiff April 2026 leave-to-amend / proposed SAC materials; **plaintiff consolidated opposition package (801 draft build)** — six core instruments, SAC packet, consolidated bundles, master packet, exhibit appendices, and legacy pipeline splits under `03-CASE-CGC-25-631802/plaintiff-opposition-consolidated-apr2026/`; the **April 2026 demurrer volley** (defense filings and the original six-instrument plaintiff demurrer-opposition upload) remains in the case index; and the earlier **803-series** Anti-SLAPP opposition build remains for reference. **Legal analysis:** Anti-SLAPP authority-by-authority rebuttal and the **demurrer rebuttal hub** (ground-by-ground review) are under `08-LEGAL-ANALYSIS/`. Earlier March 2026 appeal PDF refreshes remain as described in prior sync notes.
...
> -- Defense counsel Priya D. Navaratnasingham, April 16, 2025 (Trial Day 7)
...
| Plaintiff consolidated opposition — **801 draft build** (six core filings, SAC packet, bundles, master packet, exhibits) | **[Consolidated opposition hub](03-CASE-CGC-25-631802/plaintiff-opposition-consolidated-apr2026/README.md)** |
| Plaintiff leave / proposed SAC (April 14 consolidated packet + 801 rebuild PDFs) | [631802 index](03-CASE-CGC-25-631802/INDEX.md) → **Plaintiff filings (April 2026): leave** |
| Plaintiff opposition to Anti-SLAPP (**801 rebuild** + earlier 803-series build) | [631802 index](03-CASE-CGC-25-631802/INDEX.md) → **Plaintiff filings (April 2026): opposition** |
| Plaintiff opposition to Demurrer (original six-instrument upload + **801 opposition memorandum**) | [631802 index](03-CASE-CGC-25-631802/INDEX.md) → **April 2026 Demurrer Volley** & **Plaintiff consolidated opposition** |
...
| **[Complaints & Accountability](#complaints--accountability)** | Bar complaints, judicial complaint |

---

## The Evidence

The central evidentiary record of the case. The 911 call captures the driver's admission; body camera footage records the eyewitness; the police report omitted all of it.
...
|----------|--------------|-----------------|
| **911 Call** -- Abdelhalim | Driver admits: "BOOM! I just hit him. HIT HIM." Authenticated under oath: "Yes. That is my voice." (RT 8, l. 1979) | Defense told court it was "news to me" and of "unknown provenance" |
| **911 Call** -- Passerby | Witness reports hit-and-run: "no van ... nobody helping him" | Same suppression posture |
| **Body Camera Footage** | Eyewitness Dustin Rosemond: "The man in the van hit the guy" (RT 10, p. 39) | Defense admitted on Day 7 these were "provided by Dolan" |
| **CAD Dispatch Logs** | Contemporaneous emergency dispatch corroboration | Part of same production defense denied receiving |
| **Supplemental Police Report** | Corroborates Plaintiff's account | Excluded at trial based on defense's false representation |
...
| Passerby Witness 911 Call (hit-and-run report) | [Listen (WAV)](https://3454993913-files.gitbook.io/~/files/v0/b/gitbook-x-prod.appspot.com/o/spaces%2FtIVN0Y2w6yXTopfO7VxT%2Fuploads%2Fe5wRmkO0sugks94khtDB%2FHIT-RUN-911.wav?alt=media&token=6d37a6be-fbc2-4d4b-a98e-d2e68494c2fe) |
...
**Full evidence with transcripts, images, and documents:** [evidence.md](evidence.md) | [evidence.html](evidence.html)
...
On April 23, 2025, a jury returned a 9-3 defense verdict -- the minimum civil majority. Plaintiff alleges the verdict was procured through extrinsic fraud: defense counsel made false representations to the court about receipt and possession of critical evidence, causing the court to deny continuances and exclude material evidence based on those false representations. When defense counsel casually admitted on Trial Day 7 that the body-worn camera footage was "provided by Dolan," the artifice collapsed. The transcript captured both the lie and the confession.

Plaintiff constructed three independent post-trial proceedings, each with its own legal theory, decision-maker, standard of review, and independent remedy lane -- engineered so that a successful defense posture in one case automatically generates a concession or adverse inference in the others.

| # | Proceeding | Case No. | Forum | Theory |
|---|------------|----------|-------|--------|
| 1 | **[Appeal](#1-appeal--a173827)** | A173827 | Court of Appeal, 1st Dist., Div. 3 | Instructional error, evidentiary error, juror misconduct |
| 2 | **[Equity Action](#2-equity-action--cgc-25-631801)** | CGC-25-631801 | SF Superior Court | Independent action to set aside judgment for extrinsic fraud |
| 3 | **[Insurance Fraud / UCL](#3-insurance-fraud--ucl--cgc-25-631802)** | CGC-25-631802 | SF Superior Court | CSAA's pre-litigation false denial letter; bad faith; UCL |
| 4 | **[Underlying Trial](#4-underlying-trial--cgc-21-594102)** | CGC-21-594102 | SF Superior Court | Pedestrian-vehicle collision; 9-3 defense verdict |
...
[View full index](01-APPEAL/INDEX.md)
...
[View full index](02-CASE-CGC-25-631801/INDEX.md)
...
- [Fatal Proof: The Navaratnasingham "Dolan" Admission](08-LEGAL-ANALYSIS/FATAL-PROOF-NAVARATNASINGHAM-DOLAN-ADMISSION-EXTRINSIC-FRAUD.md)

---

### 3. Insurance Fraud / UCL -- CGC-25-631802

**Forum:** San Francisco Superior Court
**Theory:** CSAA's pre-litigation false denial letter (21 days post-collision); bad faith; Unfair Competition Law

[View full index](03-CASE-CGC-25-631802/INDEX.md)
...
**April 2026 (same case):** Anti-SLAPP defense PDFs; leave / SAC packet(s); **[plaintiff consolidated opposition (801 draft)](03-CASE-CGC-25-631802/plaintiff-opposition-consolidated-apr2026/README.md)**; earlier **803-series** opposition PDFs; and the **Demurrer volley** (defense filings and Plaintiff's six-instrument opposition upload): [631802 index](03-CASE-CGC-25-631802/INDEX.md). **Analysis:** [Anti-SLAPP rebuttal hub](08-LEGAL-ANALYSIS/anti-slapp-rebuttal/INDEX.md) | [Demurrer rebuttal hub](08-LEGAL-ANALYSIS/demurrer-rebuttal/INDEX.md).
...
**Verdict:** 9-3 defense verdict, April 23, 2025

Plaintiff Franciscus Dylan Rosario was struck by a vehicle driven by Defendant Subhi Abdelhalim in a San Francisco crosswalk on February 4, 2021. The driver called 911 and admitted striking the pedestrian. The jury returned a 9-3 defense verdict -- the minimum civil majority -- after the defense made false representations to the court that caused the exclusion and delay of critical evidence.

**Operational linchpin:** On April 16, 2025, defense counsel stated: *"Sure. They were provided by Dolan. He has had them for whatever, sure."* This admission is irreconcilable with her prior sworn representations that the materials were "not produced during discovery" and of "unknown provenance."
...
| Trial Day 7 | April 16, 2025 | [PDF](04-EXHIBITS/EXHIBIT-Trial-Day7-April16-2025.pdf) |
| Trial Day 8 | April 17, 2025 | [PDF](04-EXHIBITS/EXHIBIT-Trial-Day8-April17-2025.pdf) |

---

## Legal Analysis

In-depth analytical documents drawn from the certified record. Each document cites to specific transcript pages and court filings.
...
[View full evidence/complaints index](06-EVIDENCE/INDEX.md)
...
[View pleadings index](pleadings/README.md)

Consolidated memoranda, demands, requests for admission, and CSAA service masters across both post-trial cases.

---

## Support Filings

[View full support filings index](07-SUPPORT-FILINGS/INDEX.md)

Certificates, consents, notices, and strategy documents supporting the litigation.
...
### CGC-25-631801 (Equity Action) and CGC-21-594102 (Trial)
...
### CGC-25-631802 (Insurance Fraud / UCL)
...
├── evidence.md                       # Central evidence page (911 audio, video, images)
├── evidence.html                     # Evidence with embedded video/audio players
...
├── 05-TRANSCRIPTS/                   # Reporter transcripts, depositions, hearings
...
└── NOVEL/                            # Rosario v. Goliath (narrative)
    ├── README.md
    ├── CHAPTERS/
    ├── Rosario.Thriller.pdf
    ├── Rosario.Thriller.kindle.epub
    └── reader.html
```
...
- [Case overview and full document index](ROSARIO.md)
- [Available Evidence -- 911 audio, body camera, images](evidence.md) | [evidence.html](evidence.html)
- [Legal Analysis Index](08-LEGAL-ANALYSIS/INDEX.md)
