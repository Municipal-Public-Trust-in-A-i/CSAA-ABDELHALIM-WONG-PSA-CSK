...
```mermaid
flowchart TD
 P1["Part I: Customer Status<br/>CCP 425.17(c) + INS 790.03(h)<br/>+ 10 CCR 2695.2(c)"]
 P2["Part II: 425.17(c) Gateway<br/>Simpson Strong-Tie / Club Members<br/>Flatley / Lefebvre"]
 P3["Part III: Regulatory Floor<br/>INS 790.03(h)(1),(3),(5),(13)<br/>10 CCR 2695.3 to 2695.7"]
 P4["Part IV: Third-Party Standing<br/>Moradi-Shalal preserved channel<br/>Zhang / Park / Bonni / Baral"]
 DA["Defeat Anti-SLAPP<br/>special motion barred at gateway"]
 DD["Defeat Demurrer<br/>CCP 430.10(e) sufficiency satisfied"]
 LA["Leave to Amend SAC<br/>predicates catalogued and pleaded"]
 P1 --> P2
 P1 --> P3
 P2 --> DA
 P3 --> DA
...
```mermaid
sequenceDiagram
 participant V as Feb 4 2021 Collision
 participant C as CSAA Insurance Exchange
 participant SR as Sarah Rash Claim Rep
 participant P as Plaintiff Claimant
 participant U as Underlying CGC-21-594102
 participant K as Carbone Smith and Koyama
 participant PSA as Phillips Spallas and Angstadt
 participant CT as Trial Court
 V->>C: Notice of loss and claim 1004-09-1054 opened
 C->>SR: Assignment to claim representative
 SR->>P: Claim correspondence regulated delivery
 SR->>P: Feb 25 2021 twenty-one-day denial letter
 Note right of SR: 10 CCR 2695.7 b b1 b3 d and INS 790.03 h1 h3 h5 h13
 P->>U: Files underlying personal-injury action
 C->>K: Retains panel counsel delivery via agent
 K->>PSA: May 4 2023 inter-firm transfer of file
 PSA->>CT: Jan 17 2025 motions in limine 6 and 17 not produced unknown origin
 PSA->>CT: Feb 18 2025 RT 141 lines 4 to 11 same representations
 CT->>U: Apr 16 2025 verdict 9 to 3 defense and RT 7 and 213 lines 13 to 15 admission
 U-->>P: Corrupted record produced through panel-counsel statements
```
...
```mermaid
flowchart LR
 Q1{"Defendant primarily engaged in business of selling or leasing goods or services?"}
 Q2{"Insurance named on the face of subdivision c?"}
 Q3{"Statement or conduct in course of delivering goods or services<br/>OR representations of fact about business operations?"}
 Q4{"Audience is buyer or customer<br/>OR within regulatory<br/>investigation context?"}
 OUT["Carve-out applies<br/>section 425.16 unavailable<br/>special motion barred at gateway"]
 SST["Simpson Strong-Tie 2010<br/>49 Cal.4th 12<br/>categorical character"]
 CM["Club Members 2008<br/>45 Cal.4th 309<br/>gateway-first sequencing"]
 FL["Flatley 2006 / Lefebvre 2011<br/>illegal-conduct gateway<br/>speaker-neutral"]
 Q1 -- "Yes: CSAA licensed insurer" --> Q2
 Q2 -- "Yes: statutory text" --> Q3
 Q3 -- "Yes: Feb 25, 2021 denial" --> Q4
 Q4 -- "Yes: claimant + reg context" --> OUT
 SST -. "categorical" .-> OUT
 CM -. "sequencing" .-> OUT
 FL -. "independent strip" .-> OUT
```
...
```mermaid
flowchart TD
 RS["INS 790.03(h)(3)<br/>Reasonable Standards for<br/>Prompt Investigation"]
 TFO["10 CCR 2695.7(d)<br/>Thorough, Fair, Objective<br/>Investigation"]
 AB["INS 790.03(h)(13) +<br/>10 CCR 2695.7(b)(1)<br/>Reasonable Explanation /<br/>All Bases on Denial"]
 DOI["10 CCR 2695.7(b)(3)<br/>DOI Review Notice"]
 EG["Egan v. Mutual of Omaha<br/>24 Cal.3d 809<br/>Duty to Investigate"]
 WI["Wilson v. 21st Century<br/>42 Cal.4th 713<br/>Genuine-Dispute Boundary"]
 EN["Engalla v. Permanente<br/>15 Cal.4th 951<br/>Reckless Disregard"]
 F1["FAIL: no 911 audio"]
 F2["FAIL: no CAD log"]
 F3["FAIL: no body-cam footage"]
 F4["FAIL: no Silent-Witness retrieval log"]
 F5["FAIL: concluded recital at day 21"]
 F6["FAIL: no DOI review notice in letter"]
 RS --> TFO
 TFO --> AB
 AB --> DOI
 RS --> EG
...
```mermaid
flowchart TD
 RD["INS 790.03(h)<br/>Regulatory duty to claimants"]
 MS["Moradi-Shalal 1988<br/>preserves regulatory channel<br/>+ overlapping common-law claims"]
 ZH["Zhang 2013<br/>57 Cal.4th 364<br/>section 17200 unlawful predicate"]
 S204["BPC 17204 Standing<br/>injury in fact + lost money or property<br/>no privity required"]
 DC["CIV 1709 / 1710<br/>Common-law deceit<br/>no privity required"]
 CF["CIV 1573<br/>Constructive fraud<br/>quasi-fiduciary trust"]
 SH["Shafer v. Berger Kahn<br/>107 Cal.App.4th 54<br/>Attorney candor to non-clients"]
 DCD["Park / Bonni / Baral<br/>Discrete-claim doctrine<br/>defeats all-in anti-SLAPP framing"]
 RD --> MS
 MS --> ZH
 ZH --> S204
 MS --> DC
 MS --> CF
 MS --> SH
 DCD -. "severs each cause of action" .-> S204
 DCD -. "severs each cause of action" .-> DC
 DCD -. "severs each cause of action" .-> CF
 DCD -. "severs each cause of action" .-> SH
```
