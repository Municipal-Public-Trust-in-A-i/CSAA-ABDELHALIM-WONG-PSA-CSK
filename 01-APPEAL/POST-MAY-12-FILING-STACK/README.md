...
```mermaid
gantt
    title Post-May-12-2026 filing cadence (Day 0 = service of notice of entry)
    dateFormat X
    axisFormat Day %s
    section Day_5
    01 Objections to proposed order (CRC 3.1312(a))           :obj,  0, 5
    section Day_10
    02 Reconsideration (CCP 1008(a))                          :rec, 0, 10
    section Day_15
    03 Notice of intention - new trial (CCP 657, 659)         :nt,  0, 15
    04 Notice of intention - vacate (CCP 663, 663a)           :vac, 0, 15
    section Day_60plus
    05 Notice of appeal (CCP 904.1(a)(13); CRC 8.108 tolled)  :app, 0, 60
```
