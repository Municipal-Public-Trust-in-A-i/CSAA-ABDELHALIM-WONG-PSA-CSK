\newcommand{\docshorttitle}{NTC LODGING SUPPL.\ AUTH.\ --- \S 425.17(c) CROSS-HEARING (CGC-25-631802)}
...
\item \textit{Royal Globe Ins.\ Co.\ v.\ Superior Court} (1979) 23 Cal.3d 880; \textit{Moradi-Shalal v.\ Fireman's Fund Ins.\ Companies} (1988) 46 Cal.3d 287; \textit{Zhang v.\ Superior Court} (2013) 57 Cal.4th 364 (third-party claimant regulatory duties; UCL predicate).
...
In CGC-25-631802, defendants' denial-letter and claim-handling posture parallels the commercial-speech and privilege sequencing issues Plaintiff has briefed in the companion action. The same \ccp{425.17(c)} framework therefore applies across the Apr.\ 30, May 13, May 19, and demurrer calendars without amending any operative pleading here.

\subsection*{III. Why \ccp{425.17(c)} Reaches All Four Motions}

\textbf{Threshold first.} Under \textit{Club Members}, \ccp{425.17} issues are structurally prior where raised. \textbf{\ccp{47}(b) coextensive strand.} Under \textit{Action Apartment}, certain deceit channels align with the \ccp{425.16}(e) inquiry. \textbf{\ccp{436} frame.} Where defendants import anti-SLAPP-style immunity rhetoric into a \ccp{436} attack, \textit{PH II, Inc.\ v.\ Superior Court} (1995) 33 Cal.App.4th 1680, 1682--83 supplies a strike-specific guardrail for the May 19, 2026 hearing. \textbf{Amendment / \ccp{425.16} sequencing.} For the Apr.\ 30, 2026 MFL/SAC hearing, Plaintiff addresses over-read \textit{Simmons}-style futility arguments through \textit{JKC3H8 v.\ Colton} (2013) 221 Cal.App.4th 468 and \textit{Nguyen-Lam v.\ Cao} (2009) 171 Cal.App.4th 871.
...
\ccp{425.17}(d) limits certain ``public interest'' carve-out arguments for particular categories of defendants. On the facts Plaintiff has pleaded about commercial insurance claim handling, defendants cannot reposition this dispute as a ``media / internet / large nonprofit'' \ccp{425.17}(d) case to sidestep \ccp{425.17}(c).

\subsection*{VI. Procedural Posture}

This lodging does not amend or expand the briefing record. Physical copies of all lodged materials are provided herewith pursuant to \calrules{3.1306(c)}. An accompanying RJN seeks judicial notice of the operative statute and regulation texts.
