---
title: Global Defense-Facing Settlement Communication — Unified Exposure Narrative
status: draft-ready-to-complete-placeholders
wordcount_target: "approximately 4200 words — ballpark magnitudes only"
---
...
```mermaid
flowchart TB
  ApealNode[Appeal_A173827_no_direct_money]
  EquityNode[Equity_CGC631801_vacatur_treble_punitive_ancillary]
  CarrierNode[Fraud_UCL_CGC631802_CSAA_only]
  RetrialNode[Retrial_CGC21_PI_and_insured_punitive]
  GlobalNode[Global_modeled_aggregate_nine_figures]
  ApealNode -->|reversal_and_remand| RetrialNode
  EquityNode -->|vacatur_new_trial| RetrialNode
  EquityNode -->|credibility_and_ratification| CarrierNode
  RetrialNode --> GlobalNode
  EquityNode --> GlobalNode
  CarrierNode --> GlobalNode
```
