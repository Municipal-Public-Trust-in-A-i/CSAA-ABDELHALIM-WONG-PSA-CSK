% Shared pleading-paper preamble for CGC-25-631801 TAC-RESPONSE court PDFs (extends DEFENSE 801 court style).
...
% --- TOC / TOA hyperlink infrastructure (avoid hyperref's \\toclink name clash) ---
